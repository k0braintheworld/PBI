...
export const Icon = {
  ...
  database: (p) => (<S {...p}><ellipse cx="12" cy="6" rx="6.5" ry="2.4" /><path d="M5.5 6v11.5c0 1.3 2.9 2.4 6.5 2.4s6.5-1.1 6.5-2.4V6" /><path d="M5.5 11.7c0 1.3 2.9 2.4 6.5 2.4s6.5-1.1 6.5-2.4" /></S>),
