...
export const Icon = {
  ...
  database: (p) => (<S {...p}><ellipse cx="12" cy="6.5" rx="6.5" ry="2.4" /><path d="M5.5 6.5v11c0 1.3 2.9 2.4 6.5 2.4s6.5-1.1 6.5-2.4v-11" /><path d="M5.5 12c0 1.3 2.9 2.4 6.5 2.4s6.5-1.1 6.5-2.4" /></S>),
  ...
  shield: (p) => (<S {...p}><path d="M12 3.5l7 3v5c0 4.5-3 7.8-7 9-4-1.2-7-4.5-7-9V6.5z" /><path d="M9 12.5l2 2 4-4" /></S>),
  ...
  layers: (p) => (<S {...p}><path d="M12 4.5l9 5-9 5-9-5 9-5z" /><path d="M3 14.5l9 5 9-5" /></S>),
